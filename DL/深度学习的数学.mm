...
<node TEXT="2.12 最优化问题和回归分析" FOLDED="true" ID="ID_952897795" CREATED="1732778199696" MODIFIED="1732778208127">
...
<node TEXT="3.2 神经网络的变量的关系式" FOLDED="true" ID="ID_8742043" CREATED="1732855933651" MODIFIED="1732855939503">
<node TEXT="神经网络的变量的矩阵表示" ID="ID_327933792" CREATED="1733020778791" MODIFIED="1733020790416"/>
</node>
<node TEXT="3.3. 学习数据和正解" FOLDED="true" ID="ID_1007749374" CREATED="1732855939683" MODIFIED="1732855946934">
<node TEXT="回归分析的学习数据和正解" ID="ID_891477136" CREATED="1733020808227" MODIFIED="1733020815193">
<node TEXT="利用事先提供的数据（学习数据）来确定权重和偏置，这在神经网络中称为学习，这在数学上称为最优化，最优化的目标函数是代价函数" ID="ID_1724004955" CREATED="1733020988434" MODIFIED="1733022936040">
<arrowlink DESTINATION="ID_1961352918"/>
<arrowlink DESTINATION="ID_31103986"/>
</node>
<node TEXT="学习的逻辑：使得神经网络算出的预测值与学习数据的正解的总体误差达到最小" ID="ID_1439405060" CREATED="1733021780157" MODIFIED="1733021808872"/>
</node>
<node TEXT="神经网络的学习数据和正解" ID="ID_1126425980" CREATED="1733022023807" MODIFIED="1733022030142"/>
<node TEXT="正解的表示" ID="ID_1322372061" CREATED="1733022083562" MODIFIED="1733022087291">
<node TEXT="交叉熵和Sigmoid函数可以消除Sigmoid函数的冗长性，提高梯度下降法的计算速度" ID="ID_476715912" CREATED="1733022242183" MODIFIED="1733022703001"/>
</node>
</node>
<node TEXT="3.4 神经网络的代价函数" FOLDED="true" ID="ID_31103986" CREATED="1732855947162" MODIFIED="1732855954612">
<node TEXT="表示模型准确度的代价函数" ID="ID_437692009" CREATED="1733022942183" MODIFIED="1733022952885">
<node TEXT="也称为损失函数、目的函数、误差函数等" ID="ID_1700446209" CREATED="1733023009144" MODIFIED="1733023023545"/>
</node>
<node TEXT="回归分析的回顾" ID="ID_634351371" CREATED="1733023026531" MODIFIED="1733023034506">
<node TEXT="定义全部数据的误差的最标准、最简单的方法就是求平方误差的总和，使其达到最小的参数" ID="ID_48632883" CREATED="1733023097917" MODIFIED="1733023152382"/>
</node>
<node TEXT="最优化的基础：代价函数的最小化" ID="ID_1735388444" CREATED="1733025487391" MODIFIED="1733025498427">
<node TEXT="回归分析和神经网络中确定模型的方式是相同的" ID="ID_1560353443" CREATED="1733025548081" MODIFIED="1733025563994"/>
<node TEXT="神经网络的权重和偏置相当于回归方程的回归系数和截距" ID="ID_1671474621" CREATED="1733025564316" MODIFIED="1733025586075"/>
</node>
<node TEXT="神经网络的代价函数" ID="ID_1073955802" CREATED="1733025591445" MODIFIED="1733025597055"/>
<node TEXT="参数的个数和数据的规模" ID="ID_1988542463" CREATED="1733026126445" MODIFIED="1733026134043">
<node TEXT="数据的规模（即构成数据的元素个数）只是需要大于等于数学模型的参数个数，才能确定数学模型" ID="ID_323362705" CREATED="1733026158514" MODIFIED="1733026204193"/>
</node>
<node TEXT="神经网络和回归分析的差异" ID="ID_799268044" CREATED="1733026207277" MODIFIED="1733026213267">
<node TEXT="相比回归分析中使用的模型的参数，神经网络中使用的参数的数目十分巨大" ID="ID_1233961128" CREATED="1733026216333" MODIFIED="1733026243132"/>
<node TEXT="线性回归分析中使用的函数为一次式，神经网络中使用的函数（激活函数）不是一次式" ID="ID_1576751473" CREATED="1733026244263" MODIFIED="1733026284913"/>
<node TEXT="相比回归分析，神经网络需要更强大的数学工具，其中代表性的一种方法就是误差反向传播法" ID="ID_1610112496" CREATED="1733026351241" MODIFIED="1733026394960">
<arrowlink DESTINATION="ID_93811717"/>
</node>
</node>
</node>
...
<node TEXT="4. 神经网络和误差反向传播法" FOLDED="true" POSITION="bottom_or_right" ID="ID_569063129" CREATED="1732756759534" MODIFIED="1733042937004">
<icon BUILTIN="yes"/>
...
<node TEXT="误差反向传播法的特点是将繁杂的导数计算替换为数列的递推关系式" ID="ID_445718508" CREATED="1733038002160" MODIFIED="1733038029720"/>
<node TEXT="通过递推关系式越过导数计算" ID="ID_582461586" CREATED="1733043278409" MODIFIED="1733043290674">
<node TEXT="误差反向传播法的特点是将繁杂的导数计算替换为数列的递推关系式" ID="ID_671740670" CREATED="1733043336757" MODIFIED="1733043382169">
<arrowlink DESTINATION="ID_1531493386"/>
</node>
</node>
</node>
...
<node TEXT="5.1 小恶魔来讲解卷积神经网络的结构" ID="ID_537349984" CREATED="1733046113808" MODIFIED="1733046127798">
<node TEXT="卷积层 convolution layer" ID="ID_789942457" CREATED="1733046202093" MODIFIED="1733046212409"/>
</node>
<node TEXT="5.2 将小恶魔的工作翻译为卷积神经网络的语言" ID="ID_1894299089" CREATED="1733048943900" MODIFIED="1733048969882">
<node TEXT="将相似度汇总，就是根据过滤器S得到的卷积(convolution)的结果，称为特征映射(feature map)，这样的过滤器的计算称为卷积" ID="ID_740463663" CREATED="1733049135467" MODIFIED="1733049223733"/>
<node TEXT="卷积层的各个神经单元通过激活函数来处理加权输入，并将处理结果作为神经单元的输出，这样卷积层的处理就完成了" ID="ID_700835913" CREATED="1733049434495" MODIFIED="1733049474615"/>
<node TEXT="真正的深度学习" POSITION="bottom_or_right" ID="ID_1651919197" CREATED="1733050042944" MODIFIED="1733050049594">
<node TEXT="TensorFlow" ID="ID_172091250" CREATED="1733050049605" MODIFIED="1733050053714"/>
<node TEXT="Azure" ID="ID_718492684" CREATED="1733050053890" MODIFIED="1733050056144"/>
<node TEXT="Watson" ID="ID_1538807836" CREATED="1733050056340" MODIFIED="1733050058918"/>
<node TEXT="Amazon Machine Learning" ID="ID_1555321718" CREATED="1733050059068" MODIFIED="1733050064246"/>
</node>
</node>
<node TEXT="5.3 卷积神经网络的变量关系式" ID="ID_1386416057" CREATED="1733050077604" MODIFIED="1733050088071"/>
</node>
</node>
</map>
